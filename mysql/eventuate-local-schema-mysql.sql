create database tweetservice;
GRANT ALL PRIVILEGES ON tweetservice.* TO 'mysqluser'@'%' WITH GRANT OPTION;

create database mailservice;
GRANT ALL PRIVILEGES ON mailservice.* TO 'mysqluser'@'%' WITH GRANT OPTION;
